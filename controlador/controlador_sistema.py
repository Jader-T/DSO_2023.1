...
class ControladorSistema:
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.configura_usuarios, 2: self.configura_loja, 3: self.configura_produto, 4: self.configura_cotacao, 5: self.configura_compra,  0: self.encerra_sistema}
